...
global.thum = fs.readFileSync("./assets/help.mp4") //ur thumb pic
global.log0 = fs.readFileSync("./ZeroTwoMedia/image5.jpg") //ur logo pic
global.err4r = fs.readFileSync("./ZeroTwoMedia/image2.jpg") //ur error pic
global.thumb = fs.readFileSync("./ZeroTwoMedia/image3.jpg")

global.ytname = "YT: 𝗮𝘆𝗼 𝗼𝗳𝗳𝗶𝗰𝗶𝗮𝗹"
global.location = "India, Sultanpur, Uttar Pradesh"
global.botscript = "𝙨𝙘𝙧𝙞𝙥𝙩 𝙞𝙣 𝙨𝙤𝙤𝙣"
...
//═══════[modification]════════\\
global.owner = process.env.owner || ['94768678590','916307151530','94772496127'] //owner number, u can put multiple owner number, within quotations and seperated by comma.
global.pemilik = ['94768678590' , '94702979973'] //another owner number
global.premium = ['94768678590' , '94772496127'] //premium number
global.pengguna = '𝙾𝙳𝙸-𝙼𝙳' //username
global.mongodb = process.env.MONGODB_URI || "No-URI"

global.port = process.env.PORT || 5000
global.botnma = process.env.botnma || '𝙾𝙳𝙸-𝙼𝙳'//bot name
global.watermark = "𝑶𝑫𝑰 𝑴𝑫 ⵋ 𝑃𝑂𝑊𝐸𝑅𝐷 𝐵𝑌 𝙼𝚘𝚗𝚐𝚘𝙳𝙱"
global.dogeemoji = "✺"
global.botname = process.env.botnamw || '𝙾𝙳𝙸-𝙼𝙳'
global.ownernma = 'Ikshwaku Pandey' //owner name
global.ownername = process.env.ownername || 'Ikshwaku Pandey' //owner name
global.packname = '𝐎𝐃𝐈 𝐌𝐃' //sticker package name
global.author = '❀A❀Y❀O❀' //sticker author name
global.sessionName = process.env.SESSION_ID || 'No-Session'
global.zerotwo = "https://chat.whatsapp.com/IACWSXcf5Pv99dRXfMcKPi" //ur gc link
global.zerotwo2 = "https://chat.whatsapp.com/IACWSXcf5Pv99dRXfMcKPi" //ur gc link2
global.websitex = "𝚠𝚎𝚋𝚜𝚒𝚝𝚎 𝚒𝚜 𝚜𝚘𝚘𝚗" //ur website
global.prefa = ['.'] //prefix
global.sp = '❦' //design
module.exports = {
  BRANCH: '𝐚𝐲𝐨',
